...
var testRssFeedXML = RssFeedXml{
	...
	Channel: &RssFeed{
		...
		Description: &RssDescription{
			Content: "This is a constantly updating lorem ipsum feed",
		},
		Language:       "",
		...
		Items: []*RssItem{
			{
				...
				Description: &RssDescription{
					Content: "Exercitation ut Lorem sint proident.",
				},
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Ea est do quis fugiat exercitation.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Ipsum velit cillum ad laborum sit nulla exercitation consequat sint veniam culpa veniam voluptate incididunt.",
				},
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Ullamco pariatur aliqua consequat ea veniam id qui incididunt laborum.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Velit proident aliquip aliquip anim mollit voluptate laboris voluptate et occaecat occaecat laboris ea nulla.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Do in quis mollit consequat id in minim laborum sint exercitation laborum elit officia.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Irure id sint ullamco Lorem magna consectetur officia adipisicing duis incididunt.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Sunt anim excepteur esse nisi commodo culpa laborum exercitation ad anim ex elit.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Excepteur aliquip fugiat ex labore nisi.",
				},
				Content:   (*RssContent)(nil),
				Author:    "",
				Category:  "",
			...
			},
			{
				...
				Description: &RssDescription{
					Content: "Id proident adipisicing proident pariatur aute pariatur pariatur dolor dolor in voluptate dolor.",
				},
